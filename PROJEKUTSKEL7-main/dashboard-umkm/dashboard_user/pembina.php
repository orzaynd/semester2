...
<head>
    <meta charset="UTF-8">
    <title>Pembina: <?php echo htmlspecialchars(ucwords($pembina)); ?> | <?php echo htmlspecialchars($umkm_name); ?></title>
...
<body class="font-sans bg-gradient-to-br from-pink-50 via-white to-yellow-100 min-h-screen">
    ...
    <main class="max-w-6xl mx-auto px-4 py-10">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-900">Pembina: <span class="text-secondary-600"><?php echo htmlspecialchars(ucwords($pembina)); ?></span></h1>
            <p class="text-gray-600 mt-2">UMKM bimbingan oleh pembina ini telah menunjukkan kemajuan luar biasa.</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <?php for ($i = 1; $i <= 6; $i++) : ?>
            <div class="glass-card p-6 rounded-xl shadow-md border border-white">
                <h3 class="text-xl font-semibold text-gray-800 mb-2">UMKM Binaan <?php echo $i; ?></h3>
                <p class="text-gray-600 mb-4">Ringkasan aktivitas, pendampingan, dan progress dari UMKM yang dibina.</p>
